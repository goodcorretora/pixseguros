...
new class extends Component
{
    ...
    public function save()
    {
        ...
        Mail::send('mails.mailprevidencia', [
            'user_id' => Auth::id(),
            'name' => $this->name,
            'email' => $this->email,
            'phone_celular' => $this->phone_celular,
            ...
            $message->to('contato@pixseguros.com.br', 'Solicitar Previdência')
                    ->to('goodcorretora@gmail.com', 'Solicitar Previdência')
                    ->subject($this->name);
        });
    ...
    {
        return view('livewire.forms.previdencia-form');
    }
};
?>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6">
                                    ...
                                    <select wire:model="previdencia" id="previdencia" name="previdencia" autocomplete="previdencia-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-xs focus:outline-hidden focus:ring-primary-600 focus:border-primary-600 sm:text-sm">
