...
new class extends Component {
    ...
    public function save()
    {
        ...
        Mail::send('mails.mailcartao', [
            ...
            $message->to('contato@pixseguros.com.br', 'Solicitar Cartão de Crédito')
                    ->to('goodcorretora@gmail.com', 'Solicitar Cartão de Crédito')
                    ->subject($this->name);
        });
    ...
    {
        return view('livewire.forms.cartao-form');
    }
};
?>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3 pb-5">
                                    ...
                                    <select wire:model="renda" id="renda" name="renda" autocomplete="renda-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-xs focus:outline-hidden focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
                                ...
                                <div class="col-span-6 sm:col-span-3 pb-5">
                                    ...
                                    <select wire:model="bandeira" id="bandeira" name="bandeira" autocomplete="bandeira-name" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-xs focus:outline-hidden focus:ring-primary-500 focus:border-primary-500 sm:text-sm">
